...
function MockupCard() {
  ...
  return (
    <div style={{ display: "flex", gap: 60, alignItems: "stretch", marginLeft: 210 }}>
      {/* 왼쪽: 세로 스텝 네비게이션 */}
      <div style={{ width: 200, flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "center", height: "calc(100% - 20px)" }}>
