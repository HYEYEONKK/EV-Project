  ...
  return (
    <div style={{ fontFamily: "'Pretendard Variable', 'Pretendard', sans-serif", color: "#1A1A2E" }}>
      ...
      <section style={{
        ...
        <h1 style={{ fontSize: 64, fontWeight: 800, color: "#1A1A2E", lineHeight: 1.1, letterSpacing: -2, marginBottom: 20 }}>
          재무 데이터를 한눈에 파악하세요
        </h1>
        <p style={{ fontSize: 16, color: "#374151", lineHeight: 1.7, marginBottom: 28, maxWidth: 700 }}>
        ...
        {/* 구분선 */}
        <div style={{ height: 1, background: "#DFE3E6", marginBottom: 0 }} />
      </section>
