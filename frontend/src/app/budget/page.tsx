        ...
        {summaryItems.map(({ label, key }) => {
          ...
          if (!t) return (
            <div key={key} className="bg-white rounded-lg p-4 border" style={{ borderColor: "#E5E7EB", boxShadow: "var(--shadow-card)" }}>
              <p className="text-sm font-medium" style={{ color: "#A1A8B3" }}>{label} (2025 누계)</p>
              <p className="text-3xl font-bold mt-1" style={{ color: "#000" }}>—</p>
            </div>
          );
          ...
          return (
            <div key={key} className="bg-white rounded-lg p-4 border" style={{ borderColor: "#E5E7EB", boxShadow: "var(--shadow-card)" }}>
              ...
              <p className="text-sm font-semibold mt-0.5" style={{ color: positive ? "#16C784" : "#FF4747" }}>
