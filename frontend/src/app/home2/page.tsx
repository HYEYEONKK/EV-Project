...
export default function Home2Page() {
  ...
  return (
    <>
      ...
      >
        {/* Center content */}
        <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 680, padding: "0 24px", display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
          <span style={{
