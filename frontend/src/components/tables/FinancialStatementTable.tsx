        ...
        <table className="w-full text-sm">
          <thead>
            <tr style={{ backgroundColor: "#F5F7F8" }}>
              <th className="text-left px-6 py-3 text-xs font-semibold" style={{ color: "#A1A8B3" }}>항목</th>
              <th className="text-right px-6 py-3 text-xs font-semibold" style={{ color: "#A1A8B3" }}>금액 (KRW)</th>
              {rows[0]?.prevAmount !== undefined && (
                <>
                  <th className="text-right px-6 py-3 text-xs font-semibold" style={{ color: "#A1A8B3" }}>전기</th>
                  <th className="text-right px-6 py-3 text-xs font-semibold" style={{ color: "#A1A8B3" }}>증감율</th>
                </>
              )}
            </tr>
          </thead>
